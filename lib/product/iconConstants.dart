...
class IconConstants {
  ...
  // ONBOARDING ICONS
  static const Icon nextIcon = Icon(Icons.navigate_next_outlined);
  static const Icon doneIcon = Icon(Icons.done_outlined);
  ...
  // BUTTON ICONS
  static const Icon floatingActionButtonIcon = Icon(Icons.add_circle_outline_sharp);

  // NAVIGATION ICONS
  static const Icon cardIcon = Icon(Icons.view_list_rounded);
  static const Icon personIcon = Icon(Icons.person_outline);

  static const Icon editIcon = Icon(Icons.edit);
  static const Icon arrowBackIcon = Icon(Icons.arrow_back_outlined);
  static const Icon saveIcon = Icon(Icons.save_outlined);
